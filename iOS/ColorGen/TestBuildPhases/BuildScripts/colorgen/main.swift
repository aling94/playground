...
final class ColorAssets: Decodable, Encodable {
    ...
    func extensionFile() -> String {
        ...
        //  \(projectName)
        //
        //  Please do not edit this file. This file was automatically generated.
        //  If you wish to configure the colors generated, please make edits to the file found at
        //  \(sourceLocation)
        //
...
extension URL {
    ...
    static let source = root.appendingPathComponent(colorSource, isDirectory: false)
    ...
    static let assets = projectRoot.appendingPathComponent(assetsFolder, isDirectory: true)
    static let colorFile = projectRoot.appendingPathComponent(colorFileName, isDirectory: false)
    
    static let colors = assets.appendingPathComponent(paletteFolder, isDirectory: true)
    static let aliases = assets.appendingPathComponent(aliasesFolder, isDirectory: true)
}

// MARK: - Names
let colorSource = "ColorSource.json"
let projectName = "TestBuildPhases"
let colorFileName = "Colors.swift"
let assetsFolder = "Colors.xcassets"
